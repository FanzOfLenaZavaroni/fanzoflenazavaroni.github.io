...
title: "Lena's Timeline By Year: 1993"
maintitle: "Lena's Timeline By Year: 1993"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1993" selected>1993</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1993" class="active">1993</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1993 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
