...
title: "Lena's Timeline By Year: 1978"
maintitle: "Lena's Timeline By Year: 1978"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1978" selected>1978</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1978" class="active">1978</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1978 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
