...
title: "Lena's Timeline By Year: 1992"
maintitle: "Lena's Timeline By Year: 1992"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1992" selected>1992</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1992" class="active">1992</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1992 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
