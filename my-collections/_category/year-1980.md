...
title: "Lena's Timeline By Year: 1980"
maintitle: "Lena's Timeline By Year: 1980"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1980" selected>1980</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1980" class="active">1980</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1980 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
