...
title: "Lena's Timeline By Year: 1994"
maintitle: "Lena's Timeline By Year: 1994"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1994" selected>1994</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1994" class="active">1994</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1994 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
