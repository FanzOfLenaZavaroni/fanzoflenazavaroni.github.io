...
title: "Lena's Timeline By Year: 1966"
maintitle: "Lena's Timeline By Year: 1966"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1966" selected>1966</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1966" class="active">1966</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1966 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
