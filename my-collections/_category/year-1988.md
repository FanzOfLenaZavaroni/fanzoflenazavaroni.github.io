...
title: "Lena's Timeline By Year: 1988"
maintitle: "Lena's Timeline By Year: 1988"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1988" selected>1988</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1988" class="active">1988</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1988 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
