...
title: "Lena's Timeline By Year: 1989"
maintitle: "Lena's Timeline By Year: 1989"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1989" selected>1989</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1989" class="active">1989</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1989 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
