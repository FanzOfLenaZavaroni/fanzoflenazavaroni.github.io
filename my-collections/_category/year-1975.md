...
title: "Lena's Timeline By Year: 1975"
maintitle: "Lena's Timeline By Year: 1975"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1975" selected>1975</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1975" class="active">1975</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1975 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
