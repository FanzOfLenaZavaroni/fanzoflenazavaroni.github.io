...
title: "Lena's Timeline By Year: 1961"
maintitle: "Lena's Timeline By Year: 1961"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      <option value="/category/year-1961" selected>1961</option>
    ...
    <div class="year-links">
      <a href="/category/year-1961" class="active">1961</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1961 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
