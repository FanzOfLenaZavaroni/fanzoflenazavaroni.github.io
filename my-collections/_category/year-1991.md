...
title: "Lena's Timeline By Year: 1991"
maintitle: "Lena's Timeline By Year: 1991"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1991" selected>1991</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1991" class="active">1991</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1991 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
