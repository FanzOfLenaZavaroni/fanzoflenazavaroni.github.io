...
title: "Lena's Timeline By Year: 1976"
maintitle: "Lena's Timeline By Year: 1976"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1976" selected>1976</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1976" class="active">1976</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1976 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
