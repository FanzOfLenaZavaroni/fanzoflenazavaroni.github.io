...
title: "Lena's Timeline By Year: 1990"
maintitle: "Lena's Timeline By Year: 1990"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1990" selected>1990</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1990" class="active">1990</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1990 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
