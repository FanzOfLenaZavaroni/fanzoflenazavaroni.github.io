...
title: "Lena's Timeline By Year: 1979"
maintitle: "Lena's Timeline By Year: 1979"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1979" selected>1979</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1979" class="active">1979</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1979 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
