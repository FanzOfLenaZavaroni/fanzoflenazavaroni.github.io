...
title: "Lena's Timeline By Year: 1996"
maintitle: "Lena's Timeline By Year: 1996"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1996" selected>1996</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1996" class="active">1996</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1996 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
