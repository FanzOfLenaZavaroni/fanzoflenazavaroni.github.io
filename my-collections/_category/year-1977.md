...
title: "Lena's Timeline By Year: 1977"
maintitle: "Lena's Timeline By Year: 1977"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1977" selected>1977</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1977" class="active">1977</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1977 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
