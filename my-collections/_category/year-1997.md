...
title: "Lena's Timeline By Year: 1997"
maintitle: "Lena's Timeline By Year: 1997"
---
...
<figure class="fig3">
  <div class="CardLayout">
    ...
    <select class="year-selector" onchange="location = this.value;">
      ...
      <option value="/category/year-1997" selected>1997</option>
    ...
    <div class="year-links">
      ...
      <a href="/category/year-1997" class="active">1997</a>
    ...
    <div class="CardItem split">
      <ul>
        {% for post in site.categories.Year-1997 reversed %}
          {% if post.url %}
            <li>
              <a href="{{ post.url }}">
