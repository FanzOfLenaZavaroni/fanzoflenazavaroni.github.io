...
<ul class="columns2">
<li><strong>Presenter:</strong> Bob Langley</li>
<li><strong>Presenter:</strong> Jenny Hanley</li>
<li><strong>On screen participant:</strong> Kenny Ball And His Jazzmen</li>
<li><strong>On screen participant:</strong> Lena Zavaroni</li>
<li><strong>On screen participant:</strong> Derek Nimmo</li>
<li><strong>On screen participant:</strong> Bill Wyman</li>
</ul>

<h2 id="infobox3"><a href="#infobox3">Crew</a></h2>

<ul class="columns2">
<li><strong>Musical director:</strong> Arthur Greenslade</li>
<li><strong>Design:</strong> Sally Williams</li>
<li><strong>Sound:</strong> David Weir</li>
<li><strong>Lighting:</strong> Alec Robson</li>
<li><strong>Lighting:</strong> Barry Chatfield</li>
<li><strong>Director:</strong> Roy Norton</li>
<li><strong>Producer:</strong> Roy Ronnie</li>
