...
body {
  ...
  margin: 0;
  padding: 0;
  background: -webkit-linear-gradient(-45deg, #800024, #ea3c71);
  background: -o-linear-gradient(-45deg, #800024, #ea3c71);
  background: -moz-linear-gradient(-45deg, #800024, #ea3c71);
  background: linear-gradient(-45deg, #800024, #ea3c71);
}
...
.lena-picture {
  ...
  margin-left: -100px;
  z-index: 1;
  background: url('/54239649.png') no-repeat -30px 0px;
...
.flower {
  ...
  background: #ff8400;
  border-radius: 50%;
  box-shadow: 12px 13px 0 #fff000, -8px 15px 0 #fff000, -16px -3px 0 #fff000, 16px -6px 0 #fff000, -1.0px -16px 0 #fff000;
}
...
.cir1 { animation: transform 8s linear infinite; }
.cir2 { animation: transform 8s -3s linear infinite; }
.cir3 { animation: transform 8s -6s linear infinite; }
...
@keyframes flower {
  0% { transform: scale(10) rotate(0deg); filter: blur(30px); }
  100% { transform: scale(1) rotate(0deg); filter: none; }
}
@-webkit-keyframes flower {
  0% { -webkit-transform: scale(10) rotate(0deg); -webkit-filter: blur(30px); }
  100% { -webkit-transform: scale(1) rotate(0deg); -webkit-filter: none; }
}
</style>
